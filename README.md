...
## 📝 최근 기록
- 2026-04-15: [Janus 원논문 상세 정리 (수정본): 통합 멀티모달 이해·생성을 위한 시각 인코딩 분리 (arXiv:2410.13848)](./AI/Janus_Decoupling_Visual_Encoding_2410.13848.md)
- 2026-04-15: [Whisper 원논문 상세 정리 (수정본): 대규모 약지도 음성 인식 (arXiv:2212.04356)](./AI/Whisper_Weak_Supervision_2212.04356.md)
- 2026-04-15: [CLIP 원논문 상세 정리 (수정본): 자연어 지도 기반 전이 학습 (arXiv:2103.00020)](./AI/CLIP_Natural_Language_Supervision_2103.00020.md)
